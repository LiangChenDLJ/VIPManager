...
public class HistoryCardInfoVisualTable extends VisualTable<CardsRecord> {
    public HistoryCardInfoVisualTable(TableView<CardsRecord> tableView) {
        super(tableView, ImmutableList.of(
                ...
                new TimeVisualColumn<>("注册时间", CardsRecord::getRegtime)));
    }
}
